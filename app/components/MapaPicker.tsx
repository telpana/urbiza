...
const ZONAS_COORDS: Record<string, [number, number]> = {
  // ── Distrito Nacional ──────────────────────────────────────────────────────
  'piantini':            [18.4720, -69.9360],
  'naco':                [18.4840, -69.9330],
  'bella vista':         [18.4620, -69.9400],
  'serrales':            [18.4630, -69.9490],
  'arroyo hondo':        [18.4970, -69.9680],
  'viejo arroyo hondo':  [18.5070, -69.9720],
  'los cacicazgos':      [18.5000, -69.9530],
  'urbanizacion real':   [18.4910, -69.9590],
  'gazcue':              [18.4735, -69.9080],
  'ciudad colonial':     [18.4740, -69.8855],
  'evaristo morales':    [18.4790, -69.9350],
  'miramar':             [18.4700, -69.9170],
  'la esperilla':        [18.4755, -69.9305],
  'cristo rey':          [18.4860, -69.9590],
  'villa consuelo':      [18.4760, -69.8930],
  'ensanche ozama':      [18.4850, -69.8870],
  'ensanche isabelita':  [18.4700, -69.9040],
  'distrito nacional':   [18.4861, -69.9312],

  // ── Santo Domingo (provincia) ─────────────────────────────────────────────
  'santo domingo':        [18.4861, -69.9312],
  'santo domingo este':   [18.4980, -69.8430],
  'santo domingo norte':  [18.5760, -69.9240],
  'santo domingo oeste':  [18.5000, -70.0390],
  'boca chica':           [18.4490, -69.6080],
  'los tres brazos':      [18.5100, -69.8400],
  'alma rosa':            [18.5020, -69.8130],
  'los mina':             [18.5100, -69.8720],
  ...
  'uvero alto':           [18.7940, -68.3800],
  'macao':                [18.7440, -68.5580],
  'cortecito':            [18.7080, -68.4220],
  ...
  // ── Samaná ────────────────────────────────────────────────────────────────
  'samana':          [19.2060, -69.3360],
  'las terrenas':    [19.3160, -69.5310],
  'el portillo':     [19.2780, -69.4550],
  'coson':           [19.3400, -69.5700],
  'las galeras':     [19.2330, -69.2210],
  'sanchez':         [19.2329, -69.6157],
  'el limon':        [19.2730, -69.4720],
  'rancho espanol':  [19.2450, -69.3680],
