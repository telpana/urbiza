...
const ZONAS_COORDS: Record<string, [number, number]> = {
  ...
  // Santo Domingo
  'santo domingo este': [18.5000, -69.8500], 'santo domingo norte': [18.5700, -69.9300],
  'santo domingo oeste': [18.4900, -70.0400], 'boca chica': [18.4490, -69.6080],
  'los tres brazos': [18.5100, -69.8400], 'alma rosa': [18.5050, -69.8150],
  'los mina': [18.5100, -69.8700], 'san isidro': [18.4970, -69.8170],
  // La Altagracia
