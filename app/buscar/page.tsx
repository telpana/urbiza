...
const ZONAS_COORDS: Record<string, [number, number]> = {
  ...
  // La Altagracia
  'punta cana': [18.5674, -68.3634], 'downtown punta cana': [18.638436, -68.391718], 'bavaro': [18.6950, -68.4300], 'pueblo bavaro': [18.6350, -68.4300], 'cap cana': [18.5100, -68.3900],
  'los corales': [18.6600, -68.4500], 'cabeza de toro': [18.7100, -68.4600], 'uvero alto': [18.7200, -68.3800],
