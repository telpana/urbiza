          ...
          <div className="propiedad-sidebar" style={{ position: 'sticky', top: 70 }}>
            <div style={{ background: '#fff', borderRadius: 8, overflow: 'hidden', marginBottom: 16, boxShadow: '0 2px 12px rgba(0,0,0,0.08)' }}>
              ...
              <div style={{ padding: '16px 18px' }}>
                ...
                {telVisible && (
                  <div style={{ background: '#e0f5f7', border: '1px solid #b2dde2', borderRadius: 5, padding: '12px 14px', marginBottom: 14 }}>
                    <div style={{ fontSize: 11, color: '#555', marginBottom: 6, textAlign: 'center' }}>{Tp.telContacto}</div>
                    {telVendedor ? (
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10, justifyContent: 'center' }}>
                        <a href={`tel:${telVendedor}`} style={{ fontSize: 20, fontWeight: 700, color: '#006D77', textDecoration: 'none' }}>{telVendedor}</a>
                        <a
                          ...
                          aria-label="WhatsApp"
                          style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#25D366', borderRadius: '50%', width: 36, height: 36, flexShrink: 0, textDecoration: 'none' }}
                        >
                      ...
                      <span style={{ fontSize: 13, color: '#888', display: 'block', textAlign: 'center' }}>{Tp.sinTelefono}</span>
                    )}
                  </div>
                )}
