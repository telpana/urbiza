          ...
          <div style={{ background: '#fff', borderRadius: 10, padding: '32px 28px', boxShadow: '0 2px 16px rgba(0,0,0,0.08)' }}>
            ...
            <div style={{ marginBottom: 18 }}>
              ...
              <input
                ...
                style={{ width: '100%', border: '1.5px solid #e0e0e0', borderRadius: 6, padding: '11px 14px', fontSize: 14, outline: 'none', color: '#222', boxSizing: 'border-box', transition: 'border-color 0.15s' }}
            ...
            <button style={{ all: 'unset', width: '100%', background: '#006D77', color: '#fff', padding: '13px', borderRadius: 6, fontSize: 15, fontWeight: 600, cursor: 'pointer', textAlign: 'center', display: 'block', boxSizing: 'border-box', marginBottom: 16 }}>
              Entrar
            </button>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <button style={{ all: 'unset', width: '100%', border: '1.5px solid #e0e0e0', borderRadius: 6, padding: '11px', fontSize: 14, fontWeight: 500, cursor: 'pointer', textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, boxSizing: 'border-box', color: '#333' }}>
