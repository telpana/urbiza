...
export const t = {
  es: {
    ...
    registro: {
      ...
      profesional: 'Profesional', profesionalDesc: 'Anuncios ilimitados y funciones avanzadas · 90 días GRATIS · Código WELCOME',
    ...
    completarPerfil: {
      ...
      err_tipo: 'Elige el tipo de cuenta', err_nombre: 'Introduce tu nombre', err_telefono: 'Introduce tu teléfono', err_telefono_corto: 'Introduce un número de teléfono válido',
    },
    panel: {
      ...
      publicar: {
        ...
        tituloPlaceholder: 'Ej: Apartamento en Piantini',
      ...
      planes: {
        ...
        tienesCodigo: '¿Tienes un código promocional?', aplicar: 'Aplicar', codigoPlaceholder: 'Código promo', quitar: 'Quitar', activarAhora: 'Recuerda activar tu plan',
      },
      cursos: {
  ...
  en: {
    ...
    registro: {
      ...
      profesional: 'Professional', profesionalDesc: 'Unlimited listings and advanced features · 90 days FREE · Code WELCOME',
    ...
    completarPerfil: {
      ...
      err_tipo: 'Choose an account type', err_nombre: 'Enter your name', err_telefono: 'Enter your phone number', err_telefono_corto: 'Enter a valid phone number',
    },
    panel: {
      ...
      publicar: {
        ...
        tituloPlaceholder: 'E.g: Apartment in Piantini',
      ...
      planes: {
        ...
        tienesCodigo: 'Have a promo code?', aplicar: 'Apply', codigoPlaceholder: 'Promo code', quitar: 'Remove', activarAhora: 'Remember to activate your plan',
      },
      cursos: {
  ...
  fr: {
    ...
    registro: {
      ...
      profesional: 'Professionnel', profesionalDesc: 'Annonces illimitées et fonctions avancées · 90 jours GRATUITS · Code WELCOME',
    ...
    completarPerfil: {
      ...
      err_tipo: 'Choisissez un type de compte', err_nombre: 'Entrez votre nom', err_telefono: 'Entrez votre numéro de téléphone', err_telefono_corto: 'Entrez un numéro de téléphone valide',
    },
    panel: {
      ...
      publicar: {
        ...
        tituloPlaceholder: 'Ex : Appartement à Piantini',
      ...
      planes: {
        ...
        tienesCodigo: 'Vous avez un code promo ?', aplicar: 'Appliquer', codigoPlaceholder: 'Code promo', quitar: 'Retirer', activarAhora: 'N\'oubliez pas d\'activer votre plan',
      },
      cursos: {
